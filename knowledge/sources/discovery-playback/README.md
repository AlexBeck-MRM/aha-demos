...
- Any official stakeholder readouts.
- Any summary of discovery interviews or workshop notes.

## Retrieval note
Prefer this folder when the question is about process, delivery model, handoff logic, or why the repo should behave as a design brain instead of a generic doc dump.
