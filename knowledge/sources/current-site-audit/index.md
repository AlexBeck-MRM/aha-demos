...
## Working use
This is the source layer for current-state observations, comparator target selection, and ecosystem-pattern analysis.

## Ingest rule
Each new observation should be logged in a note file here before it gets promoted into distilled guidance.
Only commit regenerated comparator captures when they are being actively cited.
