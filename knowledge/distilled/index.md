...
- `audience-needs.md`: user needs and experience requirements.
- `digital-opportunity.md`: strategic opportunity framing.
- `constraints-and-non-negotiables.md`: guardrails and working constraints.
