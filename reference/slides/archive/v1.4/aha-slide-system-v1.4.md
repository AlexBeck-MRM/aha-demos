# AHA Slide System v1.4

## Scope
- Full 24 base layouts implemented from taxonomy + 6 extension layouts.
- Structure-first delivery for Figma <-> PPT round-trip reliability.
- Side-by-side rollout: pilot files retained, v1.4 added as new source set.
...
- Accent color usage: `#F05A00` and `#00A7A0` for selective emphasis.
- Type tokens:
  - Display: `92/0.94/600`
  - Section: `50/1.04/600`
  - Card: `30/1.04/600`
...
- Canvas: `CA-01`
- Closing: `CL-01`, `CL-02`
- Typographic extensions: `TY-01`, `TY-02`, `TY-03`, `TY-04`
- Image-led extensions: `IM-01`, `IM-02`

## Composition updates
- Borders are minimized on non-tabular containers and used only where structurally necessary.
- Generic cards/bands use no fill and no inner padding by default.
- Soft-fill panels are applied only to larger 2x2 text grids (for readability and rhythm).
- Material-style icon anchors are used selectively on benefit/insight callouts.
